...
FauxPasEAI_filepath = "C:\\Users\\prova\\Downloads\\Faux_pas_expert_dataset_v0.5.csv"
import csv
...
for i in fp_parser.tests:
        ...
        #print(story, question1, answer1, question2, answer2, question3, answer3, question4, answer4)
        gt_answers.extend([answer1, answer2, answer3, answer4])
